        ...
        function updateOnlineStatus() {
            ...
            chatWindow.prototype.setCollapsedModeStyles = function (){
                $('.kore-chat-window').css({
                    left: '300px',  // Set left position to 300px
            ...
            chatWindow.prototype.getChatTemplate = function (tempType) {
                ...
                {{if !(isSendButton)}}<div class="chatSendMsg"></div>{{/if}} \
            </div>';
            ...
            var chatWindowTemplate = '<script id="chat_window_tmpl" type="text/x-jqury-tmpl"> \
                ...
                <div class="minimized"  style="margin-top: 42%;margin-left: 40%;><span class="messages" style="text-align: center;margin-top: 4%;font-size: larger;">Talk to Grace</span></div> \
                <div class="kr-wiz-menu-chat defaultTheme-kore">\
                    ...
                    <div class="kore-chat-header"> \
                        <div class="chat-box-controls"> \
                            ...
                            {{/if}}\
                            <button class="reload-btn" title="${botMessages.reconnectText}">Start Over</button> \
                            <button class="close-btn" title="${botMessages.expandText}">End Conversation</button> \
                        </div> \
                    </div> \
